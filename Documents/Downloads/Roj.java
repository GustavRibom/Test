...
public class Roj extends JFrame implements ActionListener{
        ...
        setVisible(true);      
        JOptionPane.showMessageDialog(this, "Detta är Röj.\nDet gäller att undivika att klicka på minorna, vilket du kan göra genom att varje \nknapp som blivit synligt avslöjar hur många minor som ligger brevid denn rutan.");              
        }
